          ...
          <div class="content-wrapper">
            <div class="row">
               <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><b><u>All Booked Vehicles</u></b></h4>
                    <table class="table table-bordered">
                      ...
                      <%
                            ...
                            ResultSet rs = stmt.executeQuery("select * from bookings_table order by return_date asc;"); 
                              while( rs.next()){
                                  y++;
                        ...
                        <tr <% if (x%2 == 0){ out.println("class=\"table-info\""); } %>>
                          ...
                          <td style="width: 107px;">
                             ...
                             <span class="input-group-append">
                                 <button type="submit" class="btn btn-success mr-2" style="margin-right: 0px;" onclick="location.href='clear?c='+<%=bId %>">Clear</button>
                             </span>
                             </div>
                          </td>
                        </tr>
